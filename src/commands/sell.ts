...
import { executeSell } from '../services/userService';
import { formatCurrency } from '../utils/formatters';

export const command = {
    data: new SlashCommandBuilder()
        .setName('sell')
        .setDescription('Sell a crypto asset')
    ...
    async execute(interaction: any) {
        ...
        const result = await executeSell(interaction.user.id, data.symbol, amount, data.price);
